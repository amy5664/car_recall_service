...
| 기능명 | 설명 | 기여도 |
|------|------|------|
| 메인 페이지 구현 | 자동차 리콜 서비스 메인 화면 설계 및 UI 구현 | ⭐⭐⭐ |
| 리콜 센터 소개 페이지 | 리콜 센터 소개 페이지 프론트 코드 작성 | ⭐⭐⭐ |
| 리콜 센터 찾기 UI | 카카오맵 기반 리콜 센터 위치 조회 화면 UI 구현 | ⭐⭐⭐ |
| 리콜 센터 찾기 기능 | 리콜 센터 검색 및 지도 연동 기능 구현 | ⭐⭐⭐ |
| 리콜 데이터 통계 화면 | 리콜 데이터 기반 통계 화면 UI 설계 및 구현 | ⭐ |
| 리콜 데이터 시각화 | 리콜 현황 정보를 그래프·지표 형태로 시각화 | ⭐⭐ |
